...
export default function AboutMeShell({
  ...
  return (
    <div className="relative flex h-dvh flex-col overflow-hidden overscroll-none bg-[radial-gradient(circle_at_20%_15%,#ffffff_0%,#f7f9fb_43%,#eff1f5_100%)] font-[family-name:var(--font-geist-sans)] text-slate-800">
      <AsciiFlowBackground />
      <header className="sticky top-0 z-30 shrink-0 border-b border-white/70 bg-white/60 backdrop-blur-md">
      ...
      <div className="relative z-10 flex min-h-0 flex-1 flex-col">
        <div className="relative z-20 mx-auto w-full max-w-6xl shrink-0 bg-gradient-to-b from-[#f7f9fb]/80 via-[#f7f9fb]/70 to-transparent px-4 pb-2 pt-8 sm:px-6 sm:pt-10">
